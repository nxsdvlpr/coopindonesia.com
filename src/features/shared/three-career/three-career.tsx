  ...
  return (
    <Section>
      <Flexbox align="normal" justify="normal" flow="col" gap="2xl">
        ...
        <ThreeCareerCard threeCareers={threeCareers} />

        <ThreeCareerTable threeCareers={threeCareers} />
      </Flexbox>
    </Section>
  )
}
