    ...
    <Flexbox align="normal" flow="col" gap="sm">
      <Flexbox flow="col" gap="xs" align="normal">
        <Typo size="xl" color="gray-900" fontWeight="bold">
          Kontak Mitra LPK COOP Indonesia
        </Typo>
        <Typo size="md">
          Anda juga dapat menghubungai Mitra LPK COOP Indonesia di beberapa
          Wilayah, antara lain:
        </Typo>
      </Flexbox>
      ...
      <Flexbox flow="col" gap="2xl" align="normal">
        {locations.map((location, index) => (
          <Flexbox key={index} flow="col" align="normal" gap="xs">
            ...
            <ul className="grid list-disc grid-cols-2 gap-x-12 gap-y-2 py-0.5 pl-4">
              {location.offices.map((office) => (
                <li key={office.name} className="text-base text-gray-700">
                  {office.name}
