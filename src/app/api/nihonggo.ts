export const nihonggoDataStatic = {
...
export const nihonggoIsbDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Sekolah ISB',
  subtitle: `**Aren't Dreams There to Come True! <br/> Everyone has a dream.**`,
  content: {
    title: 'Sekolah ISB',
    image: {
...
export const nihonggoAnabukiDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
