export const intershipDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Tentang Magang',
  subtitle:
    'Program penempatan peserta magang ke Jepang merupakan salah satu program pelatihan kerja yang dilakukan oleh Pemerintah Jepang dan ditujukan untuk para Lulusan SMA/SMK sederajat. ',
  image: {
  ...
  contents: [
    {
      images: [
        ...
        },
        {
          ...
          alt: 'program-internship-image-3-coop-indonesia',
        },
      ],
      body: `Program pemagangan ke Jepang ini dilaksanakan selama 3 tahun. Namun, peserta (atau Jisshusei) juga diberi kesempatan untuk memperpanjang hingga 5 tahun. Waktu pelaksanaan magang ini dibagi dalam beberapa tahap, antara lain:\n\n 1. Bulan pertama disebut masa training atau masa Jisshusei yang dilakukan di training center.\n 2. Bulan ke-2 sampai 12 adalah masa evaluasi kompetensi\n 3. Program pemagangan bulan kedua sampai dengan tahun ketiga disebut technical intern training atau masa Jisshusei.\n 4. Perpanjangan magang menjadi 5 tahun. Perpanjangan masa magang ini bisa dilakukan apabila peserta dan perusahaan sepakat untuk memperpanjang masa praktek kerja.`,
    },
    {
      images: [
        {
...
export const internshipDocumentDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
...
export const internshipPlacementProgressDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
...
export const internshipPlacementDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Penempatan',
  images: [
    {
...
export const internshipPreSelectionDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Pra Seleksi',
  images: [
    {
...
export const internshipProgramFlowDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Alur Program',
  steps: [
    {
...
export const internshipRightsObligationsDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
...
2. **Selama di Jepang**
  ...
  titleObligations: 'Kewajiban Peserta',
...
export const internshipTermsConditionsDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
...
export const internshipTrainingDataStatic = {
  info: 'PROGRAM PEMAGANGAN KE JEPANG',
  title: 'Pelatihan',
  images: [
    {
