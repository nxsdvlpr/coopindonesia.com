  ...
  programs: [
    {
      ...
      href: '/program/internship/registration',
    ...
    },
    {
      ...
      description:
        'Melalui program Internship, mahasiswa(i) akan mendapatkan berbagai bimbingan dalam pekerjaan, memperoleh skillset atau networking di dunia pekerjaan. ',
    },
    {
      title: 'Program Usaha Mandiri',
      src: '/featured-programs/image-3.svg',
      alt: 'hero-image-coop-indonesia',
      href: '/program/post-internship',
      description:
