export const aboutAtAGlanceDataStatic = {
  ...
  contents: [
    {
      image: {
        src: '/about/at-a-glance-image-1.svg',
...
export const aboutOrganizationStructure = {
  ...
  representativeOffice: {
    title: 'Kantor Perwakilan Jepang',
    members: [
      {
  ...
  development: {
    title: 'Departemen Pengembangan Usaha',
    members: [
      {
  ...
  education: {
    ...
    publicRelations: {
      ...
      members: ['Yusron Ahmadi', 'Ahmad Sumarna, S, Sos.'],
    },
    corporateSecretary: {
      label: 'Corporate Secretary:',
      members: ['Rizal Muhamad Dahlan, S.Ak'],
    },
