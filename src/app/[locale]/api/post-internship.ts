export const postInternshipDataStatic = {
...
export const postInternshipPalmSugarDataStatic = {
  info: 'PROGRAM USAHA MANDIRI',
  title: 'Gula Aren',
  content: {
    title: 'Gula Aren',
...
export const postInternshipFurusatoAgribisnisDataStatic = {
  info: 'PROGRAM USAHA MANDIRI',
...
export const postInternshiProselindoTeaDataStatic = {
  info: 'PROGRAM USAHA MANDIRI',
  title: 'Roselindo Tea',
  contents: {
    title: 'Roselindo Tea',
